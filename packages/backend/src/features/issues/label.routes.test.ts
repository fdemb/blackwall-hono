...
describe("Label Routes", () => {
    ...
    const createLabel = async (name: string) => {
        ...
        const res = await client.labels.$post(
            {
                json: { name },
            },
            {
    ...
    describe("GET /labels", () => {
        it("should return empty array when no labels exist", async () => {
            const { client, headers } = getCtx();
            const res = await client.labels.$get(
                {},
                {
                    headers: headers(),
                },
    ...
    describe("GET /labels/:labelId", () => {
        it("should return label by id", async () => {
            ...
            const { client, headers } = getCtx();
            const res = await client.labels[":labelId"].$get(
                {
    ...
    describe("DELETE /labels/:labelId", () => {
        it("should delete a label", async () => {
            ...
            const { client, headers } = getCtx();
            const res = await client.labels[":labelId"].$delete(
                {
                    param: { labelId: createJson.label.id },
                },
                {
            ...
            const getRes = await client.labels[":labelId"].$get(
                {
                    param: { labelId: createJson.label.id },
                },
                {
